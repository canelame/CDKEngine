...
void Buffer::setVAO(unsigned int vao, unsigned int array_buffer_id, unsigned int element_buffer_id){
  data_->vao_ = vao;
  data_->element_buffer_id = element_buffer_id;
  data_->array_buffer_id = array_buffer_id;
}
...
int Buffer::getBufferIndex(){
  return data_->element_buffer_id;
}